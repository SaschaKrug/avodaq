;(function(exports) {
  ...
  var calendarGenerators = {
    ...
    ics: function(event, eClass, calendarName) {
      ...
      var eventDescription = event.description.replace(/<\/p>/g, '\\n\\n');
      eventDescription = eventDescription.replace(/<br>/g,'\\n\\n');
      eventDescription = eventDescription.replace(/<p>/g,'');
      eventDescription = eventDescription.replace(/\\n\\n /g,'\\n\\n');
      eventDescription = strip(eventDescription);

      var href = encodeURI(
        'data:text/calendar;charset=utf8,' + [
          'BEGIN:VCALENDAR',
          'PRODID:https://www.avodaq.com',
          'VERSION:2.0',
          'BEGIN:VEVENT',
          'URL:' + document.URL,
          'DTSTART:' + (startTime || ''),
          ...
          'LOCATION:' + (event.address || ''),
          'UID:' + event.dtstamp + startTime + endTime,
          'END:VEVENT',
          'END:VCALENDAR'].join('\n'));

      return '<a class="ics-file-download ' + eClass + '" target="_blank" href="' +
        href + '">' + calendarName + ' Kalender</a>';
    },
