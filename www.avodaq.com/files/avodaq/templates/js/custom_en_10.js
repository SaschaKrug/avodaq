$(document).ready(function() {
	...
	$('#fullpage').fullpage({
		...
		anchors: ['home', 'about-us', 'solutions', 'news', 'megatrends', 'partner', 'jobs', 'contact', 'imprint', 'legal-notice'],
		menu: '#menu',
		resize : false,
		...
		afterResize: function() {
			// duplicate following section (see at bottom of script)
